...
# Initialize dataset
test_dataset = KTH_Dataset(root_dir="/home/nfs/inf6/data/datasets/kth_actions/processed", sequence_length=50,split="test", transform=transforms1,use_saved_samples=False)
train_dataset = KTH_Dataset(root_dir="/home/nfs/inf6/data/datasets/kth_actions/processed", sequence_length=50,split="train", transform=transforms1,use_saved_samples=False)
